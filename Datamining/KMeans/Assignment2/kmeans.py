...
def kmeans(centroids, data, type):
    if (type == 0):
    ...
    if convergence == 1:
        ...
        return kmeans(centroids, data, type)
...
if __name__ == "__main__":
    # Type 0 uses average vector of a cluster as the centroid, any other value	 uses the nearest dataset to the average vector 
    type = 0
    featspace = process()
    ...
    for k in range(2, 21):
        ...
        for i in range(0, iterations):
            ...
            data = kmeans(centroids, data, type)
