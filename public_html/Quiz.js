...
// The third index of the array corresponds to the index of the correct answer.
...
// If the checked box has an id with a zeroth index the same as the value of that box, then the score will be inremented by 1.
function getScore()
{
	document.getElementById('scoreBox').innerHTML = "";
	score = 0;
	...
	// The score is given and the radio buttons are cleared, telling the user what the correct answers were.
